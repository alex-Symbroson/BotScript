...
#define _BS_EXT_HPP_
	...
	#define ONCE(cmd) do { cmd } while(0)
	...
	#if _DEBUG_ > 1
		#ifndef CUSTOM_BEGIN
			#define BEGIN(s, ...) printf(" \033[1;33m*\033[2;32m%s\t line %4i %s(" s ")\033[0;37m\n", __FILE__, __LINE__, __func__, ##__VA_ARGS__)
			#define END(s, ...) printf(" \033[1;31m*\033[2;32m%s\t line %4i %s(" s ")\033[0;37m\n", __FILE__, __LINE__, __func__, ##__VA_ARGS__)
		#else
			#define BEGIN_1(class, s, ...) printf(" \033[1;33m*\033[2;32m%s\t line %4i %s::%s(" s ")\033[0;37m\n", __FILE__, __LINE__, class, __func__, ##__VA_ARGS__)
			#define END_1(class, s, ...) printf(" \033[1;31m*\033[2;32m%s\t line %4i %s::%s(" s ")\033[0;37m\n", __FILE__, __LINE__, class, __func__, ##__VA_ARGS__)
		#endif
	#else
		#ifndef CUSTOM_BEGIN
			#define BEGIN(...)
	...
	#define PRINT_STATUS() printf("compiled: " _DATE_S_ _TIME_S_ "\n\n", __DATE__, __TIME__)
